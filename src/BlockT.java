...
public class BlockT extends Block {
    ...
    public BlockT(Field field){
        ...
        switch (currentState){
            case 0:
                locations.add(0, new Location(tempx - 1, 0, color));
                locations.add(1, new Location(tempx, 0, color));
                locations.add(2, new Location(tempx + 1, 0, color));
            ...
            case 2:
                ...
                locations.add(3, new Location(tempx, 0, color));
                break;
            case 3:
