...
public class BlockZ extends Block {
    ...
    public BlockZ(Field field){
        ...
        switch (currentState){
            ...
            case 1:
                ...
                locations.add(1, new Location(tempx + 1, 1, color));
                locations.add(2, new Location(tempx, 2, color));
    ...
    public boolean rotate(MyCube[][] allCubes) {
        switch (currentState){
            case 1:
                if(allCubes[locations.get(0).getY() + 1][locations.get(0).getX() - 2] == null &&
                    ...
                    locations.get(0).setLocation(-2, 1);
